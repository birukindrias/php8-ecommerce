    ...
    <div class="signup_">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input placeholder="Enter Address" required type="file" name="cust_image">
            </div>
            ...
            <div class="form-group">
                ...
                <input name="cpass" placeholder="Enter confuirm password" required type="password">
            </div>
