...
<body>
   ...
   $id= $_SESSION['id'][0];
    ...
    <div class="item">
            <div class="img">
                <img src="img/<?php echo $row['Pro_desc']; ?>" alt="">
            </div>
            <div class="buttons">
                <button>view Product</button>
                <form action="" method="POST">
                <input placeholder="Enter First Name" value="<?php echo $row['Pro_id']; ?>"  type="integer" name="qnty">
                <input placeholder="Enter First Name" value="<?php echo '1'; ?>"  type="integer" name="product_pro_id">
