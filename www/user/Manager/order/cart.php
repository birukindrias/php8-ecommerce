...
<body>
                ...
                <table>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><?= $row['Pro_price'] ?></td>
                                <td>
                                    <a href="delete_catagory.php?id=<?php echo $row['Pro_id']; ?>" class="badge badge-danger">Delete</a>
                                </td>
                            </tr>
    ...
    <div class="action">
       ...
       <?php  if (!empty($rows)) {
                    ...
                    ?>
        <a href=""><button type="submit" name="cart"> Continue Shipping</button></a>
        </form>
        <a href="">Checkout</a>
        <div class="totial">
            <?php
